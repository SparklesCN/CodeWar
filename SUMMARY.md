...
* [Collections](collections/README.md)
	* [华为](collections/huawei/README.md)
		* [0. 剔除字符串中重复字符](collections/huawei/0/README.md)
		* [1. 字符串最后一个单词的长度](collections/huawei/1/README.md)
		* [2. 计算目标字符个数](collections/huawei/2/README.md)
		* [3. 随机数去重和排序](collections/huawei/3/README.md)
		* [4. 字符串分割](collections/huawei/4/README.md)
		* [5. 进制转换](collections/huawei/5/README.md)
		* [6. 质数因子](collections/huawei/6/README.md)
		* [7. 取近似值](collections/huawei/7/README.md)
		* [8. 合并表数据](collections/huawei/8/README.md)
		* [9. 提取不重复的整数](collections/huawei/9/README.md)
		* [10. 字符个数统计](collections/huawei/10/README.md)
		* [11. 数字颠倒](collections/huawei/11/README.md)
		* [12. 句子逆序](collections/huawei/12/README.md)
		* [13. 字串的连接最长路径查找](collections/huawei/13/README.md)
		* [14. 求int型数据在内存中存储时1的个数](collections/huawei/14/README.md)
		* [15. 坐标移动](collections/huawei/15/README.md)
		* [16. 密码验证合格程序](collections/huawei/16/README.md)
		* [17. 简单密码](collections/huawei/17/README.md)
		* [18. 汽水瓶](collections/huawei/18/README.md)
		* [19. 删除字符串中出现次数最少的字符](collections/huawei/19/README.md)
		* [*21. 购物单*](collections/huawei/21/README.md)
		* [*22. 识别有效的IP地址和掩码并进行分类统计*](collections/huawei/22/README.md)
		* [*23. 简单错误记录*](collections/huawei/23/README.md)
		* [*24. 合唱队*](collections/huawei/24/README.md)
		* [25. 数据分类处理](collections/huawei/25/README.md)
		* [26. 字符串排序](collections/huawei/26/README.md)
		* [27. 查找兄弟单词](collections/huawei/27/README.md)
		* [*28. 素数伴侣*](collections/huawei/28/README.md)
		* [29. 字符串加解密](collections/huawei/29/README.md)
		* [*30. 字符串合并处理*](collections/huawei/30/README.md)
		* [*31. 【中级】单词倒排*](collections/huawei/31/README.md)
		* [*32. 【中级】字符串运用-密码截取*](collections/huawei/32/README.md)
		* [*33. 整数与IP地址间的转换*](collections/huawei/33/README.md)
